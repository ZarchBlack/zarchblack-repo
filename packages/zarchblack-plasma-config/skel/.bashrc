...
export XDG_CACHE_HOME="$HOME/.bin"
...
#grub issue 08/2022
alias install-grub-efi="sudo grub-install --target=x86_64-efi --efi-directory=/boot/efi --bootloader-id=ZarchBlack"
...
export PATH=$PATH:"$HOME/.local/bin:$HOME/.bin:/var/lib/flatpak/exports/bin:/.local/share/flatpak/exports/bin"

eval "$(zoxide init bash)"
eval "$(oh-my-posh init bash --config $HOME/.config/ohmyposh/zero.omp.json)"
